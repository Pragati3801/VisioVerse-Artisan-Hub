...
if ch:
    ...
    fcol2.image(Image.open("./All_pics/" + random_name))
...
if fs:
    ...
    target_vec = vecs[idx]
    fcol2.image(Image.open("./All_pics/" + st.session_state["disp_img"]))
    top5 = cdist(target_vec[None , ...] , vecs).squeeze().argsort()[1:6]
    c1.image(Image.open("./All_pics/" + names[top5[0]]))
    c1.text(names[top5[0]])
    c2.image(Image.open("./All_pics/" + names[top5[1]]))
    c3.image(Image.open("./All_pics/" + names[top5[2]]))
    c4.image(Image.open("./All_pics/" + names[top5[3]]))
    c5.image(Image.open("./All_pics/" + names[top5[4]]))
